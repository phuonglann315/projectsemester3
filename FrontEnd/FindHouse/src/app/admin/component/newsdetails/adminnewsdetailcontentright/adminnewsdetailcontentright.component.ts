...
@Component({
  ...
  selector:'adminnewsdetailcontentright',
  templateUrl: 'adminnewsdetailcontentright.component.html'
})
export class AdminNewsDetailContentRightComponent implements OnInit {
