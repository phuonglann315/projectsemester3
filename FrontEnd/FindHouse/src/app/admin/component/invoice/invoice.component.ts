...
count:number;
  ...
  ngOnInit(): void {
    ...
    erros=>{
      ...
      this.newsService.getlistbynewstypeandadmin(1,this.useradmin).then(
        trueresult =>{
      ...
      this.newsService.getlistbynewstypeandadmin(2,this.useradmin).then(
        trueresult =>{
          this.listnewsbynewstype= trueresult as News[];
      ...
      this.newsService.getlistbynewstypeandadmin(3,this.useradmin).then(
        trueresult =>{
          this.listnewsbynewstype= trueresult as News[];
