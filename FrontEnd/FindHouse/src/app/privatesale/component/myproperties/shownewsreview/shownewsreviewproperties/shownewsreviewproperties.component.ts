...
@Component({
  selector:'shownewsreviewproperties',
  templateUrl: 'shownewsreviewproperties.component.html'
})
export class ShowNewsReviewPropertiesComponent implements OnInit {
  useradmin:string;
  myinvoice:Invoice;
  ...
  ngOnInit(): void {
          ...
          trueresult =>{
            ...
            if(this.newsstatus ==1){
              this.listnewstatus=[
                ...
                {
                  newstatusid:5,
                  content:'Disable This News'
                }
              ];
            }else if(this.newsstatus ==4){
              this.listnewstatus=[
                {
                  newstatusid:1,
                  content:'Set Type Ads This News'
                },
              ];
            }
    ...
    shownextacction2(){
      ...
      if(this.getnewstype !=null){
        ...
        this.newsService.getlistbynewstypeandseller(this.newstypeid,this.useradmin).then(
          trueresult =>{
            this.listnewsbynewstype= trueresult as News[];
            console.log(this.listnewsbynewstype)
